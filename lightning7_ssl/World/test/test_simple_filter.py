...
class MyTestCase(unittest.TestCase):
    def test_ball_filter(self):
        ...
        # test avg
        records[0] = [BallDataRaw(0,0,(0,0,0),0.3),BallDataRaw(0,1,(0.1,0.1,0),0.5),BallDataRaw(0,2,(0.2,0.2,0),0.7)]
    ...
    def test_robot_filter(self):
        ...
        # test avg
        records[0] = [RobotDataRaw(0,0,(0,0),0.0),RobotDataRaw(0,1,(0.1,0.1),0.5),RobotDataRaw(0,2,(0.5,0.2),0.7)]
