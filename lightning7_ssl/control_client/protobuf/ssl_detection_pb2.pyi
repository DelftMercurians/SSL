...
class SSL_DetectionBall(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        pixel_x: builtins.float | None = ...,
        pixel_y: builtins.float | None = ...,
    ) -> None: ...
    def HasField(
        self,
...
class SSL_DetectionFrame(google.protobuf.message.Message):
    ...
    def balls(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SSL_DetectionBall]: ...
    @property
    def robots_yellow(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SSL_DetectionRobot]: ...
    @property
    def robots_blue(
        self,
    ) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SSL_DetectionRobot]: ...
    def __init__(
        ...
        *,
        ...
        t_capture: builtins.float | None = ...,
        t_sent: builtins.float | None = ...,
        camera_id: builtins.int | None = ...,
        balls: collections.abc.Iterable[global___SSL_DetectionBall] | None = ...,
        robots_yellow: collections.abc.Iterable[global___SSL_DetectionRobot] | None = ...,
        robots_blue: collections.abc.Iterable[global___SSL_DetectionRobot] | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
