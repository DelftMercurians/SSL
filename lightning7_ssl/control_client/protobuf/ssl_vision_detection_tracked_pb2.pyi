...
class _CapabilityEnumTypeWrapper(
    ...
    CAPABILITY_DETECT_MULTIPLE_BALLS: _Capability.ValueType  # 2
    CAPABILITY_DETECT_KICKED_BALLS: _Capability.ValueType  # 3
...
CAPABILITY_UNKNOWN: Capability.ValueType  # 0
CAPABILITY_DETECT_FLYING_BALLS: Capability.ValueType  # 1
CAPABILITY_DETECT_MULTIPLE_BALLS: Capability.ValueType  # 2
CAPABILITY_DETECT_KICKED_BALLS: Capability.ValueType  # 3
...
class KickedBall(google.protobuf.message.Message):
    ...
    @property
    def stop_pos(self) -> ssl_game_controller_geometry_pb2.Vector2:
        """The predicted position [m] at which the ball will come to a stop"""
    @property
    def robot_id(self) -> ssl_game_controller_common_pb2.BotId:
    ...
    def __init__(
        ...
        *,
        ...
        vel: ssl_game_controller_geometry_pb2.Vector3 | None = ...,
        start_timestamp: builtins.float | None = ...,
        stop_timestamp: builtins.float | None = ...,
...
class TrackedRobot(google.protobuf.message.Message):
    ...
    @property
    def vel(self) -> ssl_game_controller_geometry_pb2.Vector2:
        """The velocity [m/s] in the ssl-vision coordinate system"""
    ...
    def __init__(
        ...
        *,
        ...
        vel: ssl_game_controller_geometry_pb2.Vector2 | None = ...,
...
class TrackedFrame(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        balls: collections.abc.Iterable[global___TrackedBall] | None = ...,
        robots: collections.abc.Iterable[global___TrackedRobot] | None = ...,
