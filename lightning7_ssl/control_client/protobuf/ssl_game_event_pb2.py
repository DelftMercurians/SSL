...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, "ssl_game_event_pb2", globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    _GAME_EVENT._serialized_start = 25
    _GAME_EVENT._serialized_end = 775
    _GAME_EVENT_ORIGINATOR._serialized_start = 150
    _GAME_EVENT_ORIGINATOR._serialized_end = 209
    _GAME_EVENT_GAMEEVENTTYPE._serialized_start = 212
    _GAME_EVENT_GAMEEVENTTYPE._serialized_end = 717
    _GAME_EVENT_TEAM._serialized_start = 719
    _GAME_EVENT_TEAM._serialized_end = 775
