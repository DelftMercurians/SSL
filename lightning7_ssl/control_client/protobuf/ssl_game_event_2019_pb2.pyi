...
class GameEvent(google.protobuf.message.Message):
    ...
    class _TypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[GameEvent._Type.ValueType], builtins.type):  # noqa: F821
        ...
        """
        BALL_LEFT_FIELD_GOAL_LINE: GameEvent._Type.ValueType  # 7
        """triggered by autoRef"""
        AIMLESS_KICK: GameEvent._Type.ValueType  # 11
        """triggered by autoRef"""
        ATTACKER_TOO_CLOSE_TO_DEFENSE_AREA: GameEvent._Type.ValueType  # 19
        """Stopping Fouls

        triggered by autoRef
        """
        DEFENDER_IN_DEFENSE_AREA: GameEvent._Type.ValueType  # 31
        """triggered by autoRef"""
        BOUNDARY_CROSSING: GameEvent._Type.ValueType  # 41
        """triggered by autoRef"""
        KEEPER_HELD_BALL: GameEvent._Type.ValueType  # 13
        """triggered by GC"""
        BOT_DRIBBLED_BALL_TOO_FAR: GameEvent._Type.ValueType  # 17
        """triggered by autoRef"""
        BOT_PUSHED_BOT: GameEvent._Type.ValueType  # 24
        """triggered by human ref"""
        BOT_HELD_BALL_DELIBERATELY: GameEvent._Type.ValueType  # 26
        """triggered by human ref"""
        BOT_TIPPED_OVER: GameEvent._Type.ValueType  # 27
        """triggered by human ref"""
        ATTACKER_TOUCHED_BALL_IN_DEFENSE_AREA: GameEvent._Type.ValueType  # 15
        """Non-Stopping Fouls

        triggered by autoRef
        """
        BOT_KICKED_BALL_TOO_FAST: GameEvent._Type.ValueType  # 18
        """triggered by autoRef"""
        BOT_CRASH_UNIQUE: GameEvent._Type.ValueType  # 22
        """triggered by autoRef"""
        BOT_CRASH_DRAWN: GameEvent._Type.ValueType  # 21
        """triggered by autoRef"""
        DEFENDER_TOO_CLOSE_TO_KICK_POINT: GameEvent._Type.ValueType  # 29
        """Fouls while ball out of play

        triggered by autoRef
        """
        BOT_TOO_FAST_IN_STOP: GameEvent._Type.ValueType  # 28
        """triggered by autoRef"""
        BOT_INTERFERED_PLACEMENT: GameEvent._Type.ValueType  # 20
        """triggered by autoRef"""
        POSSIBLE_GOAL: GameEvent._Type.ValueType  # 39
        """Scoring goals

        triggered by autoRef
        """
        GOAL: GameEvent._Type.ValueType  # 8
        """triggered by GC"""
        INVALID_GOAL: GameEvent._Type.ValueType  # 42
        """triggered by GC"""
        ATTACKER_DOUBLE_TOUCHED_BALL: GameEvent._Type.ValueType  # 14
        """Other events

        triggered by autoRef
        """
        PLACEMENT_SUCCEEDED: GameEvent._Type.ValueType  # 5
        """triggered by autoRef"""
        PENALTY_KICK_FAILED: GameEvent._Type.ValueType  # 43
        """triggered by GC and autoRef"""
        NO_PROGRESS_IN_GAME: GameEvent._Type.ValueType  # 2
        """triggered by GC"""
        PLACEMENT_FAILED: GameEvent._Type.ValueType  # 3
        """triggered by GC"""
        MULTIPLE_CARDS: GameEvent._Type.ValueType  # 32
        """triggered by GC"""
        MULTIPLE_FOULS: GameEvent._Type.ValueType  # 34
        """triggered by GC"""
        BOT_SUBSTITUTION: GameEvent._Type.ValueType  # 37
        """triggered by GC"""
        TOO_MANY_ROBOTS: GameEvent._Type.ValueType  # 38
        """triggered by GC"""
        CHALLENGE_FLAG: GameEvent._Type.ValueType  # 44
        """triggered by GC"""
        EMERGENCY_STOP: GameEvent._Type.ValueType  # 45
        """triggered by GC"""
        UNSPORTING_BEHAVIOR_MINOR: GameEvent._Type.ValueType  # 35
        """triggered by human ref"""
        UNSPORTING_BEHAVIOR_MAJOR: GameEvent._Type.ValueType  # 36
        """triggered by human ref"""
        PREPARED: GameEvent._Type.ValueType  # 1
        """Deprecated events

        deprecated
        """
        INDIRECT_GOAL: GameEvent._Type.ValueType  # 9
        """deprecated"""
        CHIPPED_GOAL: GameEvent._Type.ValueType  # 10
        """deprecated"""
        KICK_TIMEOUT: GameEvent._Type.ValueType  # 12
        """deprecated"""
        ATTACKER_TOUCHED_OPPONENT_IN_DEFENSE_AREA: GameEvent._Type.ValueType  # 16
        """deprecated"""
        ATTACKER_TOUCHED_OPPONENT_IN_DEFENSE_AREA_SKIPPED: GameEvent._Type.ValueType  # 40
        """deprecated"""
        BOT_CRASH_UNIQUE_SKIPPED: GameEvent._Type.ValueType  # 23
        """deprecated"""
        BOT_PUSHED_BOT_SKIPPED: GameEvent._Type.ValueType  # 25
        """deprecated"""
        DEFENDER_IN_DEFENSE_AREA_PARTIALLY: GameEvent._Type.ValueType  # 30
        """deprecated"""
        MULTIPLE_PLACEMENT_FAILURES: GameEvent._Type.ValueType  # 33
        """deprecated"""
    ...
    class BallLeftField(google.protobuf.message.Message):
        ...
        by_team: ssl_game_controller_common_pb2.Team.ValueType
        """the team that last touched the ball"""
        by_bot: builtins.int
        """the bot that last touched the ball"""
        @property
        def location(self) -> ssl_game_controller_geometry_pb2.Vector2:
    ...
    class AimlessKick(google.protobuf.message.Message):
        ...
        def location(self) -> ssl_game_controller_geometry_pb2.Vector2:
            """the location where the ball left the field"""
        @property
        def kick_location(self) -> ssl_game_controller_geometry_pb2.Vector2:
    ...
    class Goal(google.protobuf.message.Message):
        ...
        kicking_team: ssl_game_controller_common_pb2.Team.ValueType
        ...
        def __init__(
            ...
            *,
            by_team: ssl_game_controller_common_pb2.Team.ValueType | None = ...,
            kicking_team: ssl_game_controller_common_pb2.Team.ValueType | None = ...,
            kicking_bot: builtins.int | None = ...,
            location: ssl_game_controller_geometry_pb2.Vector2 | None = ...,
            kick_location: ssl_game_controller_geometry_pb2.Vector2 | None = ...,
            max_ball_height: builtins.float | None = ...,
            num_robots_by_team: builtins.int | None = ...,
    ...
    class BotCrashDrawn(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            bot_yellow: builtins.int | None = ...,
            bot_blue: builtins.int | None = ...,
            location: ssl_game_controller_geometry_pb2.Vector2 | None = ...,
            crash_speed: builtins.float | None = ...,
    ...
    class BotTippedOver(google.protobuf.message.Message):
        ...
        def location(self) -> ssl_game_controller_geometry_pb2.Vector2:
            """the location of the bot"""
        @property
        def ball_location(self) -> ssl_game_controller_geometry_pb2.Vector2:
    ...
    class BotDribbledBallTooFar(google.protobuf.message.Message):
        ...
        @property
        def start(self) -> ssl_game_controller_geometry_pb2.Vector2:
            """the location where the dribbling started"""
        @property
        def end(self) -> ssl_game_controller_geometry_pb2.Vector2:
    ...
    class TooManyRobots(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            by_team: ssl_game_controller_common_pb2.Team.ValueType | None = ...,
            num_robots_allowed: builtins.int | None = ...,
    ...
    def __init__(
        self,
        *,
        type: global___GameEvent.Type.ValueType | None = ...,
        origin: collections.abc.Iterable[builtins.str] | None = ...,
        ball_left_field_touch_line: global___GameEvent.BallLeftField | None = ...,
        ball_left_field_goal_line: global___GameEvent.BallLeftField | None = ...,
        aimless_kick: global___GameEvent.AimlessKick | None = ...,
        attacker_too_close_to_defense_area: global___GameEvent.AttackerTooCloseToDefenseArea | None = ...,
        defender_in_defense_area: global___GameEvent.DefenderInDefenseArea | None = ...,
        boundary_crossing: global___GameEvent.BoundaryCrossing | None = ...,
        keeper_held_ball: global___GameEvent.KeeperHeldBall | None = ...,
        bot_dribbled_ball_too_far: global___GameEvent.BotDribbledBallTooFar | None = ...,
        ...
        defender_too_close_to_kick_point: global___GameEvent.DefenderTooCloseToKickPoint | None = ...,
        bot_too_fast_in_stop: global___GameEvent.BotTooFastInStop | None = ...,
        bot_interfered_placement: global___GameEvent.BotInterferedPlacement | None = ...,
        possible_goal: global___GameEvent.Goal | None = ...,
        goal: global___GameEvent.Goal | None = ...,
        invalid_goal: global___GameEvent.Goal | None = ...,
        attacker_double_touched_ball: global___GameEvent.AttackerDoubleTouchedBall | None = ...,
        placement_succeeded: global___GameEvent.PlacementSucceeded | None = ...,
        penalty_kick_failed: global___GameEvent.PenaltyKickFailed | None = ...,
        no_progress_in_game: global___GameEvent.NoProgressInGame | None = ...,
        placement_failed: global___GameEvent.PlacementFailed | None = ...,
        multiple_cards: global___GameEvent.MultipleCards | None = ...,
        multiple_fouls: global___GameEvent.MultipleFouls | None = ...,
        bot_substitution: global___GameEvent.BotSubstitution | None = ...,
        too_many_robots: global___GameEvent.TooManyRobots | None = ...,
        challenge_flag: global___GameEvent.ChallengeFlag | None = ...,
        emergency_stop: global___GameEvent.EmergencyStop | None = ...,
        unsporting_behavior_minor: global___GameEvent.UnsportingBehaviorMinor | None = ...,
        unsporting_behavior_major: global___GameEvent.UnsportingBehaviorMajor | None = ...,
        prepared: global___GameEvent.Prepared | None = ...,
