...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, "logfile_pb2", globals())
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b"\370\001\001"
    _UIDENTRY._serialized_start = 26
    _UIDENTRY._serialized_end = 68
    _UID._serialized_start = 70
    _UID._serialized_end = 109
    _LOGREQUEST._serialized_start = 111
    _LOGREQUEST._serialized_end = 137
    _LOGOFFERENTRY._serialized_start = 140
    _LOGOFFERENTRY._serialized_end = 305
    _LOGOFFERENTRY_QUALITY._serialized_start = 254
    _LOGOFFERENTRY_QUALITY._serialized_end = 305
    _LOGOFFER._serialized_start = 307
    _LOGOFFER._serialized_end = 358
