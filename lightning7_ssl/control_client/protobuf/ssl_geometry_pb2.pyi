...
class _SSL_FieldShapeTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SSL_FieldShapeType.ValueType], builtins.type):
    ...
    TopTouchLine: _SSL_FieldShapeType.ValueType  # 2
    BottomTouchLine: _SSL_FieldShapeType.ValueType  # 3
    LeftGoalLine: _SSL_FieldShapeType.ValueType  # 4
    RightGoalLine: _SSL_FieldShapeType.ValueType  # 5
    HalfwayLine: _SSL_FieldShapeType.ValueType  # 6
    CenterLine: _SSL_FieldShapeType.ValueType  # 7
    LeftPenaltyStretch: _SSL_FieldShapeType.ValueType  # 8
    RightPenaltyStretch: _SSL_FieldShapeType.ValueType  # 9
    LeftFieldLeftPenaltyStretch: _SSL_FieldShapeType.ValueType  # 10
    LeftFieldRightPenaltyStretch: _SSL_FieldShapeType.ValueType  # 11
    RightFieldLeftPenaltyStretch: _SSL_FieldShapeType.ValueType  # 12
    RightFieldRightPenaltyStretch: _SSL_FieldShapeType.ValueType  # 13
...
class SSL_FieldLineSegment(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        p1: global___Vector2f | None = ...,
        p2: global___Vector2f | None = ...,
...
class SSL_GeometryFieldSize(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        field_length: builtins.int | None = ...,
        field_width: builtins.int | None = ...,
        goal_width: builtins.int | None = ...,
        goal_depth: builtins.int | None = ...,
        boundary_width: builtins.int | None = ...,
        field_lines: collections.abc.Iterable[global___SSL_FieldLineSegment] | None = ...,
        field_arcs: collections.abc.Iterable[global___SSL_FieldCircularArc] | None = ...,
...
class SSL_GeometryCameraCalibration(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        principal_point_x: builtins.float | None = ...,
        principal_point_y: builtins.float | None = ...,
        distortion: builtins.float | None = ...,
        q0: builtins.float | None = ...,
        q1: builtins.float | None = ...,
        q2: builtins.float | None = ...,
        q3: builtins.float | None = ...,
        tx: builtins.float | None = ...,
        ty: builtins.float | None = ...,
        tz: builtins.float | None = ...,
        derived_camera_world_tx: builtins.float | None = ...,
        derived_camera_world_ty: builtins.float | None = ...,
        derived_camera_world_tz: builtins.float | None = ...,
...
class SSL_BallModelChipFixedLoss(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        damping_xy_first_hop: builtins.float | None = ...,
...
class SSL_GeometryData(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        field: global___SSL_GeometryFieldSize | None = ...,
