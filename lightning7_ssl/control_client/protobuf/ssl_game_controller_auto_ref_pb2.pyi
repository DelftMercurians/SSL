...
class AutoRefRegistration(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["identifier", b"identifier", "signature", b"signature"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["identifier", b"identifier", "signature", b"signature"]
    ) -> None: ...
...
class AutoRefToController(google.protobuf.message.Message):
    ...
    def HasField(
        self, field_name: typing_extensions.Literal["game_event", b"game_event", "signature", b"signature"]
    ) -> builtins.bool: ...
    def ClearField(
        self, field_name: typing_extensions.Literal["game_event", b"game_event", "signature", b"signature"]
    ) -> None: ...
